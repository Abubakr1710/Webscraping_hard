...
for desc_n in description_n:
    ...
    position = desc_get_n.find('Low')
    print(position)


    #desc_get_0 = desc_get_n.split('.')[0]
    #desc_get_2 = desc_get_n.split('.')[2]
    #newList = [desc_get_0, 'Low 11 C', desc_get_2]

    #list_desc_n.append(newList)
